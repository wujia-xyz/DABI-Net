...
def main():
    ...
    for fold, (train_idx, val_idx) in enumerate(skf.split(image_paths, labels)):
        ...
        model = DINOv2DABINetV2Model(
            ...
            load_method='local',  # Use local torch hub (hub in config)
            pooling='mean',
        ...
        for epoch in range(num_epochs):
            ...
            print(f"Epoch {epoch+1}: Loss={train_loss:.4f}, ACC={metrics['acc']:.4f}, AUC={metrics['auc']:.4f}, F1={metrics['f1']:.4f}")
